      ...
      <CardBody>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="space-y-3">
            <div>
              <div className="mb-1 text-xs font-medium text-slate-600">Preset</div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <div className="sm:col-span-2">
                <div className="mb-1 text-xs font-medium text-slate-600">Path</div>
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                <div className="text-xs font-medium text-slate-600">Body (JSON)</div>
                <Button
                  variant="ghost"
          ...
          <div className="space-y-3">
            ...
            <div className="text-sm text-slate-600">
              {/* <div className="mb-1 font-medium text-slate-900">Notes for your report</div>
